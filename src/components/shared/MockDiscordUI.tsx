...
export default function MockDiscordUI({ children }: PropsWithChildren) {
  return (
    <div className="flex min-h-[800px] max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      {/* server list */}
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        ...
        <div className="flex-1 oberflow-y-ato pt-4">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="my-1 space-y-px">
              {[...Array(4)].map((_, i) => (
                ...
                >
                  <div className="size-8 rounded bg-discord-background mr-3" />
