...
import DiscordMessage from "@/components/shared/DiscordMessage"
import Heading from "@/components/shared/Heading"
import { Icons } from "@/components/shared/icons"
import MockDiscordUI from "@/components/shared/MockDiscordUI"
    ...
    <>
      ...
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          <div>
            <h2 className="text-center textbase/7 font-semibold text-brand-600">
          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
                ...
                <div className="flex flex-1 items-center justify-center px-8 max-lg:pb-12 max-lg:pt-10 sm:px-10 lg:pb-2">
                  <Image
                    ...
                    alt="Bento box illustrating custom data tracing"
                    width={500}
                    height={300}
                    className="w-full max-lg:max-w-xs"
                  />
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)_1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  <p className="mt-2 text-lg/7 font-medium tracking-tight text-brand-950 max-lg:text-center">
                    Easy Integration
                  </p>
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    ...
                    and call our intuitive looging API from any language.
                  </p>
                </div>
